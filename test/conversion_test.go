...
func TestTaskCRDConversion(t *testing.T) {
	...
	if d := cmp.Diff(v1TaskGot, v1TaskExpected, filterTypeMeta, filterObjectMeta); d != "" {
	...
	if d := cmp.Diff(v1beta1TaskGot, v1beta1TaskExpected, filterTypeMeta, filterObjectMeta); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
}
...
func TestTaskRunCRDConversion(t *testing.T) {
	...
	if d := cmp.Diff(v1TaskRunGot, v1TaskRunExpected, filterTypeMeta, filterObjectMeta, filterLabels, filterTaskRunStatus); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
	...
	if d := cmp.Diff(v1beta1TaskRunGot, v1beta1TaskRunExpected, filterTypeMeta, filterObjectMeta, filterLabels, filterAnnotations); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
}
...
func TestPipelineCRDConversion(t *testing.T) {
	...
	if d := cmp.Diff(v1beta1PipelineGot, v1beta1PipelineExpected, filterTypeMeta, filterObjectMeta); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
}
...
func TestPipelineRunCRDConversion(t *testing.T) {
	...
	if d := cmp.Diff(v1PipelineRunGot, v1PipelineRunExpected, filterTypeMeta, filterObjectMeta); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
	...
	if d := cmp.Diff(v1beta1PipelineRunGot, v1beta1PipelineRunExpected, filterTypeMeta, filterObjectMeta, filterLabels); d != "" {
		t.Fatalf("-got, +want: %v", d)
	}
}
