...
func (p *ResolverRef) ConvertTo(ctx context.Context, sink apis.Convertible) error {
...
func (p *ResolverRef) ConvertFrom(ctx context.Context, source apis.Convertible) error {
	if apis.IsInDelete(ctx) {
		return nil
	}
