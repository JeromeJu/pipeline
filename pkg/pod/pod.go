...
func (b *Builder) Build(ctx context.Context, taskRun *v1.TaskRun, taskSpec v1.TaskSpec, transformers ...Transformer) (*corev1.Pod, error) {
	...
	steps, err = v1.MergeStepsWithOverrides(steps, taskRun.Spec.StepOverrides)
	if err != nil {
		return nil, err
	}
	...
	sidecars, err := v1.MergeSidecarsWithOverrides(taskSpec.Sidecars, taskRun.Spec.SidecarOverrides)
	if err != nil {
		return nil, err
	}
