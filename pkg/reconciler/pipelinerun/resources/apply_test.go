...
func TestApplyParameters(t *testing.T) {
	for _, tt := range []struct {
		...
		params: []v1.Param{{Name: "second-param", Value: *v1.NewStructuredValues("second-value")}},
		expected: v1.PipelineSpec{
			Params: []v1.ParamSpec{
				{Name: "first-param", Type: v1.ParamTypeString, Default: v1.NewStructuredValues("default-value")},
				{Name: "second-param", Type: v1.ParamTypeString},
		...
		params: []v1.Param{{Name: "HELLO", Value: *v1.NewStructuredValues("hello param!")}},
		expected: v1.PipelineSpec{
			Tasks: []v1.PipelineTask{{
				TaskSpec: &v1.EmbeddedTask{
					TaskSpec: v1.TaskSpec{
		...
		params: []v1.Param{{Name: "myObject", Value: *v1.NewObject(map[string]string{"key1": "hello", "key2": "world!"})}},
		expected: v1.PipelineSpec{
			Tasks: []v1.PipelineTask{{
				TaskSpec: &v1.EmbeddedTask{
					TaskSpec: v1.TaskSpec{
		...
		params: []v1.Param{{Name: "HELLO", Value: *v1.NewStructuredValues("pipeline param!")}},
		expected: v1.PipelineSpec{
			Tasks: []v1.PipelineTask{{
				TaskSpec: &v1.EmbeddedTask{
					TaskSpec: v1.TaskSpec{
		...
		params: []v1.Param{{Name: "myobject", Value: *v1.NewObject(map[string]string{
			"key1": "pipeline",
			"key2": "param!!",
		})}},
		expected: v1.PipelineSpec{
		...
		params: []v1.Param{{Name: "myobject", Value: *v1.NewObject(map[string]string{"key1": "pipeline", "key2": "param!!!"})}},
		expected: v1.PipelineSpec{
			Tasks: []v1.PipelineTask{{
				Params: []v1.Param{
					{Name: "myobject", Value: *v1.NewObject(map[string]string{
		...
		original: v1.PipelineSpec{
			Params: []v1.ParamSpec{
				{Name: "first-param", Type: v1.ParamTypeString, Default: v1.NewArrayOrString("default-value")},
				{Name: "second-param", Type: v1.ParamTypeString},
			},
			Tasks: []v1.PipelineTask{{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							...
							Value: *v1.NewArrayOrString("$(params.first-param)"),
						}, {
							Name:  "second-resolver-param",
							Value: *v1.NewArrayOrString("$(params.second-param)"),
						}},
					},
				},
			}},
		},
		params: []v1.Param{{Name: "second-param", Value: *v1.NewArrayOrString("second-value")}},
		expected: v1.PipelineSpec{
			Params: []v1.ParamSpec{
				{Name: "first-param", Type: v1.ParamTypeString, Default: v1.NewArrayOrString("default-value")},
				{Name: "second-param", Type: v1.ParamTypeString},
			...
			Tasks: []v1.PipelineTask{{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "first-resolver-param",
							Value: *v1.NewArrayOrString("default-value"),
						}, {
							Name:  "second-resolver-param",
							Value: *v1.NewArrayOrString("second-value"),
						}},
					},
				},
			}},
			...
			Tasks: []v1.PipelineTask{{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "first-resolver-param",
							Value: *v1.NewArrayOrString("$(params.myobject.key1)"),
						}, {
							Name:  "second-resolver-param",
							Value: *v1.NewArrayOrString("$(params.myobject.key2)"),
						}, {
							Name:  "third-resolver-param",
							Value: *v1.NewArrayOrString("$(params.myobject.key3)"),
						}},
					},
				},
			}},
			...
			Tasks: []v1.PipelineTask{{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "first-resolver-param",
							Value: *v1.NewArrayOrString("val1"),
						}, {
							Name:  "second-resolver-param",
							Value: *v1.NewArrayOrString("val2"),
						}, {
							Name:  "third-resolver-param",
							Value: *v1.NewArrayOrString("val1"),
						}},
...
func TestApplyTaskResults_MinimalExpression(t *testing.T) {
	for _, tt := range []struct {
		...
		resolvedResultRefs: ResolvedResultRefs{{
			Value: *v1.NewArrayOrString("arrayResultValueOne", "arrayResultValueTwo"),
			ResultReference: v1.ResultRef{
				PipelineTask: "aTask",
				Result:       "aResult",
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name: "bParam",
							Value: v1.ArrayOrString{Type: v1.ParamTypeArray,
		...
		resolvedResultRefs: ResolvedResultRefs{{
			Value: *v1.NewArrayOrString("aResultValue"),
			ResultReference: v1.ResultRef{
				PipelineTask: "aTask",
				Result:       "aResult",
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("$(tasks.aTask.results.aResult)"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("$(tasks.aTask.results.aResult[0])"),
						}, {
							Name:  "cParam",
							Value: *v1.NewArrayOrString("$(tasks.aTask.results.aResult[1])"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("arrayResultValueOne"),
						}, {
							Name:  "cParam",
							Value: *v1.NewArrayOrString("arrayResultValueTwo"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("Result value --> $(tasks.aTask.results.aResult)"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("Result value --> aResultValue"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("Result value --> $(tasks.aTask.results.aResult[0])"),
						}, {
							Name:  "cParam",
							Value: *v1.NewArrayOrString("Result value --> $(tasks.aTask.results.aResult[1])"),
						}},
					},
				},
			},
			...
			PipelineTask: &v1.PipelineTask{
				TaskRef: &v1.TaskRef{
					ResolverRef: v1.ResolverRef{
						Params: []v1.Param{{
							Name:  "bParam",
							Value: *v1.NewArrayOrString("Result value --> arrayResultValueOne"),
						}, {
							Name:  "cParam",
							Value: *v1.NewArrayOrString("Result value --> arrayResultValueTwo"),
						}},
					},
				},
			},
...
func TestApplyWorkspaces(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.description, func(t *testing.T) {
			p1 := v1.PipelineSpec{
				Tasks: []v1.PipelineTask{{
					Params: []v1.Param{{Value: *v1.NewStructuredValues(tc.variableUsage)}},
				}},
...
func TestApplyFinallyResultsToPipelineResults(t *testing.T) {
	for _, tc := range []struct {
		...
		runResults    map[string][]v1.CustomRunResult
