...
func extractResultRefsForParam(pipelineRunState PipelineRunState, param v1.Param) (ResolvedResultRefs, error) {
	expressions, ok := v1.GetVarSubstitutionExpressionsForParam(param)
	if ok {
...
func findRunResultForParam(runObj v1beta1.RunObject, reference *v1.ResultRef) (string, error) {
