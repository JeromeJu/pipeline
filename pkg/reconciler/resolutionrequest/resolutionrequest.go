...
import (
	...
	rrreconciler "github.com/tektoncd/pipeline/pkg/client/resolution/injection/reconciler/resolution/v1/resolutionrequest"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, rr *v1.ResolutionRequest) reconciler.Event {
	if rr == nil {
		return nil
	}
...
func requestDuration(rr *v1.ResolutionRequest) time.Duration {
